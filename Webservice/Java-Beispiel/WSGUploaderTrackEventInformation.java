 ...
 *
 */
public class WSGUploaderTrackEventInformation implements Uploader {
     ...
     */
    public WSGUploaderTrackEventInformation() throws Exception {
     ...
     *                           Mögliche Werte sind:
                                 - "getTrackEvents"
     *
     * @param  serviceVersion    Die Version des (certification)-TrackEventInformation Services, die aufgerufen werden soll.
     *
    ...
    public void upload(String xmlContent, String serviceOperation, String serviceVersion, boolean useCertSystem) throws Exception {
        ...
        // Die vom IT CSP bereitgestellte Basis-URL des Web Service Gateways der Deutschen Post
        ...
        if (useCertSystem == true) {
          // Ziel des Requests ist die AM-Zertifizierungsumgebung, d.h. der CertificationTrackEventInformation Service
          httpConnection.addRequestProperty("SOAPAction", "Fulfillment/CertificationTrackEventInformation/" + serviceVersion + "#" + serviceOperation);
        }
        else
        {
          // Ziel des Requests ist die AM-Produktivumgebung, d.h. der TrackEventInformation Service
          httpConnection.addRequestProperty("SOAPAction", "Fulfillment/TrackEventInformation/" + serviceVersion + "#" + serviceOperation);
        }
